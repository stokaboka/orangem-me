<template>
  <icon-text :icon="vendorInfo.icon">
    <span slot="text">
      <a class="a-href-link__text" target="_blank" :href="vendorInfo.href">{{vendorInfo.title}}</a>
    </span>
  </icon-text>
</template>
...
export default {
  ...
  computed: {
    vendorInfo () {
      if (this.vendors.hasOwnProperty(this.vendor)) {
